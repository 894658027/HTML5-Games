...
MyGame.Game.prototype = {
    create: function() {
		...
		canvasBgfour();
    	        game.time.events.add(Phaser.Timer.SECOND * 7,twoEnemys,this);
				game.time.events.add(Phaser.Timer.SECOND * 40,threeEnemys,this);
				game.time.events.add(Phaser.Timer.SECOND * 60,fourEnemys,this);
				game.time.events.add(Phaser.Timer.SECOND * 80,fiveEnemys,this);
