...
$(window).ready(function () {
    var STBG = function () {
        function STBG(config) {
            ...
            window.bgQueue.loadManifest([{ id: "black-white-bar", src: "image/bg1/black-white-bar.png" }, { id: "white-black-bar", src: "image/bg1/white-black-bar.png" }, { id: "yellow-red-bar", src: "image/bg1/yellow-red-bar.png" }, { id: "red-yellow-bar", src: "image/bg1/red-yellow-bar.png" }, { id: "black-white-box", src: "image/bg1/black-white-box.png" }, { id: "white-black-box", src: "image/bg1/white-black-box.png" }, { id: "yellow-red-box", src: "image/bg1/yellow-red-box.png" }, { id: "red-yellow-box", src: "image/bg1/red-yellow-box.png" }]);
        }
