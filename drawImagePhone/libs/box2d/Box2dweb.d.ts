	...
	**/
	export class b2Body {
		...
		**/
		 ...
		 * 使用自定义重力系统
		 */
		public useCustomGravity: boolean;

		/**
		 * 自定义重力
		 */
		public m_customGravity: Box2D.Common.Math.b2Vec2;
		/**
		 * 开始碰撞回调
		 */
		public beginContactHandler: Function;
		/**
		 * 结束碰撞回调
		 */
		public endContactHandler: Function;

		public beginContactWith(bodyB: Box2D.Dynamics.b2Body): void;

		public endContactWith(bodyB: Box2D.Dynamics.b2Body): void;
