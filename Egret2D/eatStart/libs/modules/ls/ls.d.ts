...
declare module ls {
    ...
    class ConditionBlock {
        ...
        event: AIEvent;
        status: boolean;
        currentConditionStatus: boolean[];
        loopDatas: any[];
        loopLayers: number;
        ...
        execLoopNextAction(action: Action, isloop: boolean, instances: AIObject[]): void;
        execLoopAction(isloop: boolean, instances: Array<AIObject>): void;
        /**执行单独的动作 */
        execSingleAction(action: Action, computedInstances: Array<AIObject>): any[];
        executeTrigger(targets: any[]): void;
    }
}
declare module ls {
    class Config {
...
declare module ls {
    ...
    class EventSheetDecoder {
        ...
        static collisionSearchs2: any;
        static _oldTime: number;
        static _tickInterval: number;
        static _tick: number;
         ...
         * 并且条件属性中可能会有组
         */
        static decodeConditionProperties(conditionInstance: BaseEvent, data: any): BaseEvent;
         ...
         */
        static execEvent(event: AIEvent, isTrigger: boolean, triggerTargets?: Array<any>, behaviorTarget?: BaseBehavior, compareCondition?: Condition, familyVo?: FamilyVo): void;
        static checkCollistions2(): void;
...
declare module ls {
    class AIDisplayObject extends AIObject {
        ...
        spawn($object: AIObject, $layer: any, $offsetX: any, $offsetY: any, relyOnTarget: any): any;
...
declare module ls {
    class AISystem extends AIObject {
        ...
        setObjectTimeScale($object: AIDisplayObject, $timeScale: number): void;
...
declare module ls {
    class Trigger {
        ...
        static onTrigger2(event: TriggerEvent): void;
    }
}
declare module ls {
    class Base64 {
...
declare module ls {
    ...
    class CollisionUtils {
        ...
        static getLines(container: AIDisplayObject): Array<Line>;
        /**检测与绑定刚体行为的对象碰撞 */
        static testOverlapSolid(inst: AIDisplayObject): AIDisplayObject;
        static testOverlapJumpThru(inst: AIDisplayObject, all?: boolean): Array<AIDisplayObject>;
...
declare module ls {
    class MathUtils {
        ...
        static angleClockWise(angle1: number, angle2: number): boolean;
