...
(function (ls) {
    ...
    var AITouch = (function (_super) {
        ...
        AITouch.DOUBLE_TAP_TIME = 300; //双击时间间隔
        AITouch.DOUBLE_TAP_DISTANCE = 80; //距离容差值
        AITouch.SHORT_TAP_TIME = 400;
        AITouch.LONG_TAP_TIME = 800;
        //滑屏
        //需要判断释放点与起始点的距离
        AITouch.SWIPE_DISTANCE = 150; //滑屏的距离
        AITouch.SWIPE_TIME = 200; //滑屏最小的时间，单位：毫秒
        AITouch.SWIPE_POINT_NUMS = 30; //滑屏时需要移动的点        
        return AITouch;
    }(ls.AIObject));
    ls.AITouch = AITouch;
